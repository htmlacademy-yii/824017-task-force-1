...
<div class="landing-bottom">
  <div class="landing-bottom-container">
    <h2>Последние задания на сайте</h2>
      ...
      <div class="landing-task">
        ...
        <div class="landing-task-info">
          ...
          <?php if ($task['payment']): ?>
          <span><?= $formatter->asInteger($task['payment']) ?><b> ₽</b></span>
          <?php endif; ?>
        </div>
      </div>
      <?php endforeach; ?>
   ...
   <div class="landing-bottom-container">
       <a class="button red-button" href="<?= Url::toRoute(['tasks/index']) ?>" style="height: 15px; padding-top: 20px; padding-bottom: 22px; width: 210px; display: block">смотреть все задания</a>
   </div>
</div>