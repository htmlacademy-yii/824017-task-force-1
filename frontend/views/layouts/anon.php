    ...
    <div class="main-container page-header__container page-header__container--index">
      ...
      <div class="header__account--index">
        <a href="#" class="header__account-enter open-modal" data-for="enter-form">
          <span>Вход</span></a>
        или
        <a href="<?= Url::toRoute('sign/signup') ?>" class="header__account-registration">
          Регистрация
        </a>
      </div>
    </div>
  ...
  <main>
    <div class="landing-container">
      <div class="landing-top">
        ...
        <a class="button" href="<?= Url::toRoute('sign/signup') ?>" style="height: 16.5px; display: inline-block; padding-top: 15px; padding-bottom: 15px;">Создать аккаунт</a>
      </div>
